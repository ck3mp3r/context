/**
 * Graphology ForceAtlas2 Layout - Self-contained IIFE Bundle
 * Version: 0.10.1
 * Bundled for browser use with graphology UMD global.
 *
 * Exposes: window.ForceAtlas2Layout
 *   - ForceAtlas2Layout(graph, iterations) — synchronous layout (assigns positions)
 *   - ForceAtlas2Layout.inferSettings(graph) — returns recommended settings
 */
(function () {
  'use strict';

  // =========================================================================
  // isGraph polyfill (simplified)
  // =========================================================================
  function isGraph(g) {
    return g && typeof g.order === 'number' && typeof g.forEachNode === 'function';
  }

  // =========================================================================
  // Edge weight getter (simplified — all edges weight 1)
  // =========================================================================
  ...
  function graphToByteArrays(graph, edgeWeightGetter) {
    ...
    graph.forEachEdge(function (edge, attr, source, target, sa, ta, u) {
      var sj = index[source];
      var tj = index[target];
      var weight = edgeWeightGetter(edge, attr, source, target, sa, ta, u);
  ...
  function abstractSynchronousLayout(assignToGraph, graph, params) {
    if (!isGraph(graph))
      throw new Error(
  ...
  // Default export: assign positions directly to graph
  var ForceAtlas2Layout = abstractSynchronousLayout.bind(null, true);
  ForceAtlas2Layout.assign = abstractSynchronousLayout.bind(null, true);
  ForceAtlas2Layout.positions = abstractSynchronousLayout.bind(null, false);
  ForceAtlas2Layout.inferSettings = inferSettings;
