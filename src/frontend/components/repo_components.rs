                        ...
                        view! {
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <button
                                    ...
                                    class="flex-shrink-0 text-ctp-overlay0 hover:text-ctp-text transition-colors"
                                    title="Copy to clipboard"
                                >
                                    {move || if copied.get() {
                                        view! {
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 text-ctp-green" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
